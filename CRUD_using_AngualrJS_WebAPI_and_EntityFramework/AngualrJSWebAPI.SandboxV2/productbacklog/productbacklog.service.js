...
.factory('ProductBacklog', ['$resource', '$cookieStore', '$rootScope', '$timeout',
    function ($resource, $cookieStore, $rootScope, $timeout) {
        var service = {};

        var serviceBaseUrl = config.apiurl;

        // http://localhost:58045/api/ProductBacklog?Name=Administrator
        var url = serviceBaseUrl + 'api/ProductBacklog';
