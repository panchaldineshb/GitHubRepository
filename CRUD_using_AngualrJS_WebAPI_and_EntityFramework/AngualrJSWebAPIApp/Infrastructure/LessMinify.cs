...
namespace AngualrJSWebAPIApp.Web.Infrastructure
{
    public class LessMinify : IBundleTransform
    {
        public void Process(BundleContext context, BundleResponse bundle)
        {
            ...
            {
                var fileFullName = HttpContext.Current.Request.MapPath(file.VirtualFile.VirtualPath);
                SetCurrentFilePath(lessParser, fileFullName);
                string source = File.ReadAllText(fileFullName);
                content.Append(lessEngine.TransformToCss(source, fileFullName));
                content.AppendLine();
